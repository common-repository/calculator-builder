					...
					<div id="titlediv" class="is-b-margin">
						<div id="titlewrap">
							...
							<div class="field has-addons">
								...
								<div class="control">
									<button
										class="button is-link button-large is-size-6 is-radiusless submit-btn has-background-link">
							...
							<div class="calchub-meta-field">
								...
								<div class="field has-addons">
                                    ...
                                    <span class="button is-small is-info" style="cursor: default">
                                        <?php esc_html_e( 'Tag', 'calculator-builder' ); ?>
                                    </span>
									</div>
									<div class="control">
										<input list="calc-tags" class="input is-small is-info calc-tags " name="tag"
										       type="text" value="<?php echo esc_attr( $tag ); ?>" autocomplete="off">
								...
								<div class="field has-addons">
                                    ...
                                    <span class="button is-small is-dark" id="calc-copy-action">
                                        <?php esc_html_e( 'Shortcode', 'calculator-builder' ); ?>
                                    </span>
									</div>
									<div class="control">
					...
					<div class="live-preview">
						...
						<div class="live-builder">
							<div class="columns">
								...
								<div class="column">
									<div class="formbox formbox-<?php echo absint( $tool_id ); ?>" id="calculator">
										<?php CALCHUB()->sanitize->form( $form ); ?>
									</div>
								</div>
