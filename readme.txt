...
* Integration WordPress plugin [Contact Form 7](https://wordpress.org/plugins/contact-form-7/) with Calculator Builder. Easily send the calculator result by email.
